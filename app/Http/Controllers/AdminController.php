...
class AdminController extends Controller
{
    ...
    public function toggleStatus(User $admin): RedirectResponse
    {
        ...
        // Toggle: if email_verified_at is null (inactive), set it to now (active)
        // If email_verified_at is not null (active), set it to null (inactive)
        ...
        return redirect()->route('manager.kelola.index')->with('success', "Status admin {$admin->name} berhasil diubah menjadi {$status}.");
    }

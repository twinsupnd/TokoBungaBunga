    ...
    <main>
        ...
        <div style="padding: 24px 20px;">
            <div class="breadcrumb"
                style="max-width:1100px;margin: 14px auto; display:flex; gap:8px; align-items:center; color:#6b7280;">
                <a href="{{ route('catalog.index') }}"
                    style="text-decoration:none; font-weight:600; color: inherit;">Katalog</a>
            ...
            @else
                <div style="max-width:1100px; margin:30px auto; text-align:center; color:#6b7280;">Belum ada produk.
                </div>
            @endif
        </div>

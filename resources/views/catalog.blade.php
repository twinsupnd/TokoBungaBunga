...
<div class="dashboard-container">
    ...
    @if ($products->isEmpty())
        <div class="empty-state">
            ...
            <p class="empty-text">Belum ada produk. <a href="{{ route('dashboard.jenis.index') }}">Tambah produk sekarang</a></p>
        </div>
    @else
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-footer">
                            <span class="product-price">Rp {{ number_format((float) $product->price, 0, ',', '.') }}</span>
                            <a href="{{ route('jenis.show', $product->slug) }}" class="btn-view" target="_blank">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            @endforeach

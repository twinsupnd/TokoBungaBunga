...
<div class="profil-container">
    ...
    <div class="profil-sidebar">
        <div class="profil-photo-wrapper">
            ...
            <button class="upload-btn" onclick="document.getElementById('photo-upload').click()" title="Ubah Foto Profil">Edit</button>
        ...
        <div>
            ...
            <div class="profil-role">{{ ucfirst(auth()->user()->role ?? 'User') }}</div>

...
<div class="dashboard-header">
    ...
    <p class="text-sm text-gray-500">Tambahkan jadwal/event untuk tim Anda.</p>
</div>
...
<form action="{{ route('dashboard.admin.store') }}" method="POST">
    ...
    <div style="display:grid; gap:12px;">
        ...
        <div style="display:flex; gap:12px; align-items:center;">
            ...
            <input name="category" placeholder="Category (e.g. Personal, Business)" style="flex:1;padding:8px;border:1px solid #e5e7eb;border-radius:6px;" />

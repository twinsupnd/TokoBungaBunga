...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $modelName }} - Whispering Flora</title>
        ...
        <style>
            .category-header {
                background: linear-gradient(135deg, #ffd6e8 0%, #ffb84d 100%);
                padding: 60px 50px;
                text-align: center;
                margin-bottom: 40px;
            }
    ...
    <body>
        ...
        <main>
            <div class="category-header">
                <h1>{{ $model === 'asli' ? '🌸' : '🎀' }} {{ $modelName }}</h1>
                <p>Koleksi {{ $modelName }} Pilihan dari Whispering Flora</p>
            </div>
            ...
            @else
                <div class="product-grid">
                    <div class="empty-state">
                        <div class="empty-icon">{{ $model === 'asli' ? '🌼' : '🎁' }}</div>
                        <h2 class="empty-title">Belum Ada Produk</h2>
                        <p class="empty-text">Produk {{ $modelName }} sedang tidak tersedia saat ini</p>
                    </div>
                </div>
            @endif
        </main>
